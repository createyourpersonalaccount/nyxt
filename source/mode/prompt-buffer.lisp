...
source has its own properties, such as the ability to mark suggestions.  The
same source can be used by different prompt buffers.
   ...
   (keyscheme-map
    (define-keyscheme-map "prompt-buffer-mode" ()
      ...
      (list
       ...
       "shift-return" 'return-marks-action
